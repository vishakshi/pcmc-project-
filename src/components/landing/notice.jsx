   ...
   <Box sx={{backgroundColor:'#fff',py:5}}>
    ...
    <Box sx={{display:'flex'}}>
        ...
        <Box sx={{width:{xs:'100%',md:'50%'}}}>
            ...
            <Button variant='contained' onClick={handleSignIn} size="large" sx={{color:'white',backgroundColor:'red','&:hover':{backgroundColor:'#9B3922'}}} endIcon={<LoginOutlined/>}>Register Now</Button>
            </Box>
        </Box>
    </Box>
   </Box>
