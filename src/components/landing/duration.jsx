  ...
  return (
    <Box sx={{backgroundColor:'#fff',py:3}}>
        ...
        <Grid sx={{display:'flex',p:5,flexDirection:'column',gap:5}} item md={6} >
            ...
            <Box mx='auto'><Button variant='contained' onClick={handleSignIn} size="large" endIcon={<LoginOutlined/>} sx={{color:'white',backgroundColor:'red','&:hover':{backgroundColor:'#9B3922'}}}>Register Now</Button></Box>
        </Grid>
