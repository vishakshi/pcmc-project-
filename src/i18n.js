    ...
    resources:{
        en:{
            translation:{
                ...
                testimonial4:'A soul born abnormal has to struggle to live a normal life, it is certainly painful. Divyang Bhawan Foundation is working very positively to make a change in the society such as "A home where there should be no relationship, love and humanity" for the disabled.',
                akshaylata:'Akshay Lata Ashruba Neharkar',
                testimonial5:'Divyang Bhawan Foundation is a fortunate event for the disabled people and their parents in Pimpri Chinchwad Municipal Corporation. The said foundation will continue to work in terms of their physical, educational, vocational and social rehabilitation from disability prevention measures. In this regard, the said Divyang Bhavan Foundation will be operational by appointing a well-equipped building with all facilities and experts in the field of the disabled.This innovative initiative in India is being implemented through PCMC for comprehensive rehabilitation of disabled people. It is sure that it will benefit all the disabled people and their parents in PCMC limits.All the best for the future of Divyang Bhavan Foundation.',
