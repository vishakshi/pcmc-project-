    ...
    resources:{
        en:{
            translation:{
                ...
                pimpriDescription: 'Pimpri Chinchwad Municipal Corporation is a pioneer in taking initiatives for the rights of persons with disabilities. The Municipal Corporation has implemented many effective schemes to safeguard the interests of the disabled and protect their rights. The Pimpri Chinchwad Municipal Corporation is committed to implementing the Rights of Persons with Disabilities Act, 2016 (RPwD Act 2016). Accordingly, the Municipal Corporation has established Divyang Bhavan Foundation at Morwadi, Pimpri. Sadar Bhavan works for the therapy and rehabilitation of all persons with disabilities as well as their skills and empowerment.',
                ...
                testimonial5:'Divyang Bhavan Foundation is a fortunate event for the disabled people and their parents in Pimpri Chinchwad Municipal Corporation. The said foundation will continue to work in terms of their physical, educational, vocational and social rehabilitation from disability prevention measures. In this regard, the said Divyang Bhavan Foundation will be operational by appointing a well-equipped building with all facilities and experts in the field of the disabled.This innovative initiative in India is being implemented through PCMC for comprehensive rehabilitation of disabled people. It is sure that it will benefit all the disabled people and their parents in PCMC limits.All the best for the future of Divyang Bhavan Foundation.',
                nandkumarphule:'Mr. Nand Kumar Phule, General Manager (Sec.) Maharashtra State Disability Finance and Development Corporation, Mumbai',
                ...
                pimpriChinchwadMunicipalCorporation: 'Pimpri Chinchwad Municipal Corporation',
                committedEmpowerment: 'Committed to the empowerment of the disabled - Pimpri Chinchwad Municipal Corporation',
